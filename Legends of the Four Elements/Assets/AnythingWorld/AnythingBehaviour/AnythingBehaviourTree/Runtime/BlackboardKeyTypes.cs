...
{
    // These classes extend BlackboardKey to support various Unity-specific and primitive data types,
    // facilitating typed data storage and manipulation within a behavior tree's blackboard system.
